...
CREATE TABLE IF NOT EXISTS chat_participants (
	...
	CONSTRAINT chat_participants_chat_id_fkey FOREIGN KEY (chat_id) REFERENCES public.chat_rooms(id),
...
CREATE TABLE IF NOT EXISTS messages (
	...
	CONSTRAINT messages_chat_id_fkey FOREIGN KEY (chat_id) REFERENCES public.chat_rooms(id),
...
CREATE INDEX idx_messages_chat_id_sent_at ON public.messages USING btree (chat_id, sent_at DESC);